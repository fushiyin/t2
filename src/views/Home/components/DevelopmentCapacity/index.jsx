			...
			technologies: [
				{
					...
					experience: t("tech_stack.bigdata.technologies.hadoop.experience"),
					projects: t("tech_stack.bigdata.technologies.hadoop.projects"),
				},
				{
					name: t("tech_stack.bigdata.technologies.spark.name"),
					logo: SparkLogo,
					description: t("tech_stack.bigdata.technologies.spark.description"),
					experience: t("tech_stack.bigdata.technologies.spark.experience"),
					projects: t("tech_stack.bigdata.technologies.spark.projects"),
				},
				{
					name: t("tech_stack.bigdata.technologies.kafka.name"),
					logo: KafkaLogo,
					description: t("tech_stack.bigdata.technologies.kafka.description"),
					experience: t("tech_stack.bigdata.technologies.kafka.experience"),
					projects: t("tech_stack.bigdata.technologies.kafka.projects"),
				},
				{
					...
					experience: t("tech_stack.bigdata.technologies.elasticsearch.experience"),
					projects: t("tech_stack.bigdata.technologies.elasticsearch.projects"),
				},
				{
					...
					experience: t("tech_stack.bigdata.technologies.bigQueryLogo.experience"),
					projects: t("tech_stack.bigdata.technologies.bigQueryLogo.projects"),
				},
				{
					name: t("tech_stack.bigdata.technologies.powerBI.name"),
					logo: PowerBILogo,
					description: t("tech_stack.bigdata.technologies.powerBI.description"),
					experience: t("tech_stack.bigdata.technologies.powerBI.experience"),
					projects: t("tech_stack.bigdata.technologies.powerBI.projects"),
				},
			],
		},
	];
