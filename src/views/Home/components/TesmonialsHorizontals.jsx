...
export default function TesmonialsHorizontals() {
...
function TestimonialCard({ testimonial }) {
	return (
		<Card className="bg-[#1a1a1a] border-[#333] hover:border-[#444] shadow-md hover:shadow-lg transition-all duration-300 h-full">
